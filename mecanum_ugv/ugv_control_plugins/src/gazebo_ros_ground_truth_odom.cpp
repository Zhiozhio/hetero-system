...
#include "gazebo_ros_ground_truth_odom.h"

namespace gazebo
{
GZ_REGISTER_MODEL_PLUGIN(GazeboRosGroundTruthOdom);

////////////////////////////////////////////////////////////////////////////////
// Constructor
GazeboRosGroundTruthOdom::GazeboRosGroundTruthOdom()
{
  this->seed = 0;
}
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void GazeboRosGroundTruthOdom::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf)
{
  // Get the world name.
  ...
  this->callback_queue_thread_ = boost::thread(
    boost::bind(&GazeboRosGroundTruthOdom::P3DQueueThread, this));

  // New Mechanism for Updating every World Cycle
  // Listen to the update event. This event is broadcast every
  // simulation iteration.
  this->update_connection_ = event::Events::ConnectWorldUpdateBegin(
      boost::bind(&GazeboRosGroundTruthOdom::UpdateChild, this));
}

////////////////////////////////////////////////////////////////////////////////
// Update the controller
void GazeboRosGroundTruthOdom::UpdateChild()
{
  if (!this->link_)
    return;
...
double GazeboRosGroundTruthOdom::GaussianKernel(double mu, double sigma)
{
...
void GazeboRosGroundTruthOdom::P3DQueueThread()
{
