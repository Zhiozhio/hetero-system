...
#ifndef GAZEBO_ROS_GROUND_TRUTH_ODOM_HH
#define GAZEBO_ROS_GROUND_TRUTH_ODOM_HH
...
namespace gazebo
{
  class GazeboRosGroundTruthOdom : public ModelPlugin
  {
    /// \brief Constructor
    public: GazeboRosGroundTruthOdom();

    /// \brief Destructor
    public: virtual ~GazeboRosGroundTruthOdom();
