...
#include <gazebo_ros_simple_fly_control.h>

namespace gazebo
{
GZ_REGISTER_MODEL_PLUGIN(GazeboRosSimpleFlyControl);

////////////////////////////////////////////////////////////////////////////////
// Constructor
GazeboRosSimpleFlyControl::GazeboRosSimpleFlyControl()
{
...
////////////////////////////////////////////////////////////////////////////////
// Load the controller
void GazeboRosSimpleFlyControl::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  parent_ = _model;
  ...
  ros::SubscribeOptions so = ros::SubscribeOptions::create<geometry_msgs::Wrench>(
    this->topic_name_,1,
    boost::bind( &GazeboRosSimpleFlyControl::UpdateObjectForce,this,_1),
    ros::VoidPtr(), &this->queue_);
  this->sub_ = this->rosnode_->subscribe(so);

  // Custom Callback Queue
  this->callback_queue_thread_ = boost::thread( boost::bind( &GazeboRosSimpleFlyControl::QueueThread,this ) );

  // New Mechanism for Updating every World Cycle
  // Listen to the update event. This event is broadcast every
  // simulation iteration.
  this->update_connection_ = event::Events::ConnectWorldUpdateBegin(
      boost::bind(&GazeboRosSimpleFlyControl::UpdateChild, this));
}

////////////////////////////////////////////////////////////////////////////////
// Update the controller
void GazeboRosSimpleFlyControl::UpdateObjectForce(const geometry_msgs::Wrench::ConstPtr& _msg)
{
...
////////////////////////////////////////////////////////////////////////////////
// Update the controller
void GazeboRosSimpleFlyControl::UpdateChild()
{
  this->lock_.lock();
...
void GazeboRosSimpleFlyControl::QueueThread()
{
