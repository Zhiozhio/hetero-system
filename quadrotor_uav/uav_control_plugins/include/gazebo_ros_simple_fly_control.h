...
#ifndef GAZEBO_ROS_SIMPLE_FLY_CONTROL_H
#define GAZEBO_ROS_SIMPLE_FLY_CONTROL_H
...
class GazeboRosSimpleFlyControl : public ModelPlugin
{
  /// \brief Constructor
  public: GazeboRosSimpleFlyControl();

  /// \brief Destructor
  public: virtual ~GazeboRosSimpleFlyControl();
